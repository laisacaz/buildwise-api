...
at http://www.devart.com/dotconnect/postgresql/download.html;
- open the .sln file;
- check that "Devart.Data.dll" and "Devart.Data.PostgreSql" references are correct. 
If Visual Studio complains about it, fix these references as well;
