...
{
    public class SaleServiceOrderInsertPayloadValidator : AbstractValidator<SaleServiceOrderInsertPayload>
    {
        public SaleServiceOrderInsertPayloadValidator(IUnitOfWork uow)
        {
