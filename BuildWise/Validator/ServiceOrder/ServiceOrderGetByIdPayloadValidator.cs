...
{
    public class ServiceOrderGetByIdPayloadValidator : AbstractValidator<ServiceOrderGetByIdPayload>
    {
        public ServiceOrderGetByIdPayloadValidator(IUnitOfWork uow)
        {
            RuleFor(x => x.Id)
                .GreaterThan(0)
